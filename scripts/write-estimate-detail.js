// Writes the estimate detail page using the pricing engine
const fs = require('fs')
...
const content = [
  ...
  "  smsLines.push('')",
  "  smsLines.push('Reply YES to approve or call (334) 320-7514 with questions.')",
  ...
  "          }}>{smsBody}</pre>",
  "          <a href={'sms:' + customer.phone + '?body=' + encodeURIComponent(smsBody)}",
...
const outPath = path.join(__dirname, '..', 'src', 'app', '(protected)', 'estimates', '[id]', 'page.tsx')
fs.writeFileSync(outPath, content, 'utf8')
console.log('estimates/[id]/page.tsx written (' + content.length + ' bytes)')
